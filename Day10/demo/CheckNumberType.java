...
Samir wants to play a mind game with his father. The game is – when Sameer calls out a number 
his father should say whether that number is odd or even. 
Since his father doesn't like Mathematics much he needs some help to play the game.
...
Samir's father has to identify whether the number is odd or even. 
By using the method checkNumberType the given number is identified as odd or even.
...
> Sample Output 2 :
    77 is odd
 same  questions u need add method reference functionality
 */
...
public final class CheckNumberType {
